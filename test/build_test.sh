...
hipcc -Wall -O1 -std=c++17 --offload-arch=gfx908 -lstdc++ -lm -fopenmp test_ten.cpp ../src/thaBLAS.cpp ../src/thaDNN.cpp ../src/utils.cpp ../src/seq.cpp -I../include -I/opt/rocm/include/hipblas -o test_ten_run
srun -p EM  --gres=gpu:1 ./test_ten_run

...
srun -p EM  --gres=gpu:1  hipcc -Wall -O1 -std=c++17 --offload-arch=gfx908 -lstdc++ -lm -fopenmp thaDNN.test.cpp ../src/thaBLAS.cpp ../src/thaDNN.cpp -I../include -I/opt/rocm/include/hipblas -o test_thaDNN_run

#!/bin/bash
rm demo_shuffle_hip || echo "Failed to remove demo_shuffle, skipping..."

# hipcc -Wall -O1 -std=c++17 --offload-arch=gfx908  demo_shuffle_hip.cpp -o demo_shuffle_hip
# srun -p EM --gres=gpu:1 ./demo_shuffle_hip
